...
class DataKernel():
    ...
    def GetData(self):
        ...
        if dataReady:
            ...
            #print(DataOut) # System.Collections.Generic.Dictionary`2[System.Guid,System.Collections.Generic.List`1[System.Double]]
            ...
            #print(keys.__len__()) # [<System.Guid object at 0x0000027250DF4A60>, ...]
            #print(outArr) # [array([-1.03125, -1.03125, -1.03125, -1.03125, -1.03125, -1.03125, -1.03125, -1.03125], dtype=object)]...]
            #print(outArr)
            return outArr
